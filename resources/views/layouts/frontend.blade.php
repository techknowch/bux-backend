              ...
              <li class="footer-links">
                <p>
                  <span><svg version="1.1" id="svg1" width="18" height="18" viewBox="0 0 512 512"
                    ...
                    </svg></span> 198 West 21th Street,Suite 721 New York NY 10016
                </p>
              </li>
              <li class="footer-links">
                <p><span><svg version="1.1" id="svg1" width="18" height="18" viewBox="0 0 512 512"
                    ...
                    </svg></span> <a href="tel://1234567920">1235 2355 98</a>
                </p>
              </li>
              <li class="footer-links">
                <svg version="1.1" id="svg1" width="18" height="18" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"
